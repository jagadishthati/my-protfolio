...
// import {BsInstagram} from 'react-icons/bs/instagram'
  ...
  return (
    <>
      ...
      <div className='biodata flex flex-col gap-2'>
        ...
        <div className="img ">
            <Image  className="  hover:border-4 h-[35vh] border-white-500     hover:rounded-full" src="/Profile.png" alt="" height={300} width={300} />
        </div>
